from .fuzzy import get_trapezoid_fuzzy_set, get_triangle_fuzzy_set, get_triangle_fuzzy_set, get_triangle_fuzzy_set, get_trapezoid_fuzzy_set, get_labels
from .labels import DEVIATION_FAR_LEFT, DEVIATION_FAR_RIGHT, DEVIATION_LEFT, DEVIATION_RIGHT, DEVIATION_MIDDLE
